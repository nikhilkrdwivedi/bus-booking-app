    ...
    <Container className="px-2 md:px-4 lg:px-20 xl:px-32 bg-white dark:bg-gray-800 w-full h-screen overflow-auto">
      ...
      {userBookings?.data && (
        <div className="flex flex-col h-[calc(100vh-130px)] justify-between">
          ...
          <Pagination
            page={userBookings?.pagination?.currentPage + 1}
            pages={userBookings?.pagination?.totalPages}
            total={userBookings?.pagination?.totalRecords}
            perPage={userBookings?.pagination?.limit}
            showCount
