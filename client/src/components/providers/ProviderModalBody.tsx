...
export default function ProviderModalBody({ form, onChange }: any) {
    return (
        <><Fieldset
            legend='Company'
            showLegend
            fieldsetClass="border border-gray-200 dark:border-gray-600 p-2"
        ...
        >
            ...
            >
                <div className='grid md:grid-cols-2 gap-4'>
                    <Input
                        ...
                        onChange={(e: any) => onChange(e?.target?.value, 'streetOne', 'address')}
                    />
                    <Input 
                    type="text" 
                    label='Street(2)' 
                    ...
                    onChange={(e: any) => onChange(e?.target?.value, 'streetTwo', 'address')} />
                    <Input 
                    type="text" 
                    label='City*' 
                    ...
                    onChange={(e: any) => onChange(e?.target?.value, 'state', 'address')} />
                    <Input 
                    type="text" 
                    label='Country*' 
                    placeholder='eg: India'
                    value={form?.address?.country}
                    onChange={(e: any) => onChange(e?.target?.value, 'country', 'address')} />
                    <Input 
                    type="text" 
                    label='Zip Code*' 
                    placeholder='eg: 656565'
                    value={form?.address?.zipcode}
                    onChange={(e: any) => onChange(e?.target?.value, 'zipcode', 'address')} />
                </div>
            </Fieldset>
            <Fieldset
                legend='Contact'
            ...
            >
                <div className='grid md:grid-cols-2 gap-4'>
                    ...
                    onChange={(e:any)=>onChange(e?.target?.value, 'phone','contact')}
                     />
                    <Input 
                    type='text'
                    label='Email*' 
                    ...
                    onChange={(e:any)=>onChange(e?.target?.value, 'email','contact')}
                     />
                </div>
            </Fieldset>
        </>
